...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_all(
		...
		KC_LGUI, KC_LALT, KC_LGUI, KC_SPC, KC_RGUI, KC_RALT, MO(3)), 
	...
	LAYOUT_all(
		...
		KC_TRNS, RGB_TOG, RGB_MOD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_END, KC_PGDN, KC_DOWN, KC_TRNS, KC_TRNS,
